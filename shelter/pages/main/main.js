...
let burgerButton = document.querySelector('.btn__burger'),
     ...
     linkFor = document.getElementById('linkFor')
...
window.addEventListener('click', (e) => {
  ...
  let slider1stItem = document.querySelector('.slider__item2'),
      slider2ndItem = document.querySelector('.slider__item3'),
      slider3rdItem = document.querySelector('.slider__item4'),
      arrowButton1 = document.querySelector('.slider__item1'),
      arrowButton2 = document.querySelector('.slider__item5'),
      arr = [];
      n = '';
      ...
      function sliderFiller(){
        ...
        slider1stItem.children[0].src = pets[arr[0]].img;
        slider1stItem.children[1].textContent = pets[arr[0]].name;
        slider1stItem.children[1].style.transportation = '0.5 easy-in'
        slider2ndItem.children[0].src = pets[arr[1]].img;
        slider2ndItem.children[1].textContent = pets[arr[1]].name;
        slider3rdItem.children[0].src = pets[arr[2]].img;
        slider3rdItem.children[1].textContent = pets[arr[2]].name;

        if(arr.length >= 3) arr = [];
      }
   arrowButton1.addEventListener('click', sliderFiller);
   arrowButton2.addEventListener('click', sliderFiller);      
